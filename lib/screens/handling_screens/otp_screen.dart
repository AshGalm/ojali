...
class _OtpScreenState extends State<OtpScreen> {
  ...
  verify() async {
    ...
    await auth.verifyPhoneNumber(
      ...
      verificationFailed: (verificationFailed) async {
        showCustomFlushbar(verificationFailed.message.toString(),
            Colors.redAccent, FontAwesomeIcons.info, context);
        if (kDebugMode) {
      ...
      codeAutoRetrievalTimeout: (verificationId) async {
        ...
        showCustomFlushbar(
            "Expired Code", Colors.red, FontAwesomeIcons.info, context);
      },
  ...
  void signInWithPhoneAuthCredential(
    ...
    try {
      ...
      showCustomFlushbar(
          e.message.toString(), Colors.red, FontAwesomeIcons.info, context);
    }
  }
                ...
                child: Column(
                  children: [
                    ...
                    const Padding(
                      ...
                      child: Text(
                        'أدخل الرمز المرسل إلى رقم الهاتف',
